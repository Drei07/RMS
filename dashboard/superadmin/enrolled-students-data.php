...
<body>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Enrolled Students</h1>
            <ul class="breadcrumbs">
				<li><a href="home" >Home</a></li>
				<li class="divider">|</li>
				<li><a href="" class="active">Enrolled Students</a></li>
			</ul>

            <section class="data-table">
                <div class="searchBx">
                    <input type="input" placeholder="search student LRN .." class="search" name="search_box" id="search_box"><button class="searchBtn"><i class="bx bx-search icon"></i></button>
                </div>
	...
	<script>
        ...
        {
        $.ajax({
            url:"data-table/students-data-table.php",
            method:"POST",

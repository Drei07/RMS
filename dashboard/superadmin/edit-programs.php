...
$pdoQuery = "SELECT * FROM academic_programs WHERE Id =" . $_GET['id'];
$pdoResult = $pdoConnect->prepare($pdoQuery);
$pdoExec = $pdoResult->execute(array());
$program = $pdoResult->fetch(PDO::FETCH_ASSOC);

$program_name     = $program["programs"];
...
<body>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Edit Programs</h1>
            <ul class="breadcrumbs">
				<li><a href="home" >Home</a></li>
				<li class="divider">|</li>
				<li><a href="" class="active">Edit Programs</a></li>
			</ul>
            <section class="data-form">
				<div class="header"></div>
				<div class="registration">
					<form action="controller/update-programs-controller.php?id=<?php echo $programId ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
						<div class="row gx-5 needs-validation">

							<div class="col-md-6">
								<label for="acdemic" class="form-label">Academic Program<span> *</span></label>
								<input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" value="<?php echo $program_name ?>" autocapitalize="on"  autocomplete="off" name="AProgram" id="acdemic" required>
								<div class="invalid-feedback">
								Please provide a Academic Program.
								</div>
							</div>

							<div class="col-md-6">
                                <label for="strand" class="form-label">Strand<span> *</span></label>
                                <select class="form-select form-control"  name="Strand"  autocapitalize="on" maxlength="6" autocomplete="off" id="strand" required>
                                <option selected value="<?php echo $program_strand ?>"><?php echo $program_strand ?></option>
                                <option value="Academic Strand">Academic Strand</option>
                                <option value="Technical-Vocational Livelihood Strand ">Technical-Vocational Livelihood Strand</option>
                                </select>
                                <div class="invalid-feedback">
                                    Please select a valid Strand.
                                </div>
                            </div>

							<div class="col-md-6">
								<label for="acronym" class="form-label">Acronym</label>
								<input type="text" class="form-control" value="<?php echo $acronym ?>" autocapitalize="on"  autocomplete="off" name="Acronym" id="acronym">
								<div class="invalid-feedback">
								Please provide a Acronym.
								</div>
							</div>

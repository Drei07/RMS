	...
	<section id="content">
		...
		<main>
            ...
            <ul class="breadcrumbs">
				...
				<li class="divider">|</li>
				<li><a href="" class="active">Add Programs</a></li>
			</ul>
            <section class="data-form">
				<div class="header"></div>
				<div class="registration">
					<form action="controller/add-programs-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
						<div class="row gx-5 needs-validation">

							<div class="col-md-6">
								<label for="acdemic" class="form-label">Academic Program<span> *</span></label>
								<input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" autocapitalize="on"  autocomplete="off" name="AProgram" id="acdemic" required>
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" autocapitalize="on"  autocomplete="off" name="Acronym" id="acronym">
								<div class="invalid-feedback">

...
<body>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h1 class="title"><?php echo $class_code ?></h1>
            <ul class="breadcrumbs">
				<li><a href="home" >Home</a></li>
				<li class="divider">|</li>
				<li><a href="" class="active">Class Information</a></li>
			</ul>
	...
	<script>
        ...
        {
        $.ajax({
            url:"data-table/class-enrolled-student-table.php?classId=<?php echo $classID = $_GET['classId'] ?>",
            method:"POST",

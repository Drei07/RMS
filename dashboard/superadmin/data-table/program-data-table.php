...
{
  $query .= '
  WHERE programs LIKE "%'.str_replace(' ', '%', $_POST['query']).'%"
  ';
}
...
';
  while($row=$statement->fetch(PDO::FETCH_ASSOC))
  {
    ...
    <tr>
      ...
      <td>
      <button type="button" class="btn btn-success V"><a href="edit-programs?id='.$row["Id"].'" class="edit"><i class="bx bxs-edit"></i></a></button>
      </td>        
    </tr>
    ';
  }

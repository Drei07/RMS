...
';
  while($row=$statement->fetch(PDO::FETCH_ASSOC))
  {
    ...
    <td>'.$row["LRN"].'</td>
      ...
      <td>'. ($row['phone_number']== NULL ? '' :  '+63'.$row["phone_number"].'') . '</td>
      <td>'.$row["email"].'</td>
      <td>'.$row["created_at"].'</td>
      <td><button type="button" class="btn btn-primary V"> <a href="student-profile?id='.$row["userId"].'" class="view"><i class="bx bx-low-vision"></i></a></button></td>
    </tr>
    ';
  }
}

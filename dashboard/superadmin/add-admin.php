					...
					<form action="controller/add-admin-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
						<div class="row gx-5 needs-validation">
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" autocapitalize="on" maxlength="20"  autocomplete="off" name="Position" id="position" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required>
								<div class="invalid-feedback">
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" autocapitalize="on" maxlength="15" autocomplete="off" name="EmployeeId" id="employee_id" required >
								<div class="invalid-feedback">
